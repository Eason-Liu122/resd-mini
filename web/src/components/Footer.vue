    ...
    <div class="rounded p-5">
      ...
      <div class="flex w-full text-sm justify-between pt-8 text-slate-400">
        ...
        <div class="flex">
          ...
          <button class="pl-4" @click="toWebsite('http://127.0.0.1:8899/api/cert')">证书</button>
          <button class="pl-4" @click="toWebsite('https://github.com/putyy/resd-mini')">软件源码</button>
          <button class="pl-4" @click="toWebsite('https://github.com/putyy/resd-mini/issues')">帮助支持</button>
          <button class="pl-4" @click="toWebsite('https://github.com/putyy/resd-mini/releases')">更新日志</button>
        </div>
      </div>
    </div>
  </NModal>
