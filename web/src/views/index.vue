<template>
  <div class="flex flex-col px-5 py-5">
    <div class="pb-2 z-40" @click="triggerEvent">
      <NSpace>
        <NButton v-if="isProxy" secondary type="primary" @click.stop="close">关闭代理</NButton>
        <NButton v-else tertiary type="tertiary" @click.stop="open">开启代理</NButton>
        <NButton tertiary type="info" @click.stop="batchDown">批量下载</NButton>
        <NButton tertiary type="error" @click.stop="clear">清空列表</NButton>
        <NSelect style="min-width: 100px;" placeholder="拦截类型" v-model:value="resourcesType" multiple clearable :max-tag-count="3" :options="options"></NSelect>
